...
<body>
                    ...
                    <form action="#" method="post" enctype="multipart/form-data">
                        <div class="login">
                            <div class="container-form">
                                <div class="row">
                                    <div class="col-md-6">
                                        <label for="">Cilindraje <span class="sp">*</span></label>
                                        <input type="number" class="input form-control" name="cilindraje" id="cilindraje"
                                            placeholder="Cilindraje de la moto">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="">Tiempos <span class="sp">*</span></label>
                                        <input type="number" class="input form-control" name="tiempos" id="tiempos"
                                            placeholder="tiempos" >
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="input form-control" name="placa" id="placa"
                                            placeholder="Numero de placa" maxlength="6" minlength="4" style="text-transform: uppercase;">
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    <div class="photo form-group">
                                        <label for="foto" class="col-md-6 control-label">Foto de la moto <span class="sp">*</span></label>
                                        <div class="prevPhoto">
                                        ...
                                        <center></centerZ<h6>Click en el cuadro para subir foto</h6></center>
                                ...
                                <input type="button" class="input" id="registroMotos" value="Registrar Moto">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" aria-label="Close">
                                <a href="motos" style="text-decoration:none; color:red;"><span
                        ...
                        <div style="text-align:center;">
                            <hr>
                            <a href="motos"><button type="button" class="btn btn-danger"
    ...
    <script src="../js/registroMotos.js"></script>
