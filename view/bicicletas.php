...
<body>
                    ...
                    <form action="#" method="post" enctype="multipart/form-data">
                        <div class="login">
                            <div class="container-form">
                                <div class="col-md-12">
                                    <label for="">Numero de Cedula <span class="sp">*</span></label>
                                    <input type="text" class="input form-control" name="cedula" id="cedula"
                                        placeholder="Numero de cedula">
                                </div>
                                <div class="col-md-12">
                                    <div class="photo form-group">
                                        <label for="foto" class="col-md-10 control-label">Foto de la bicicleta <span
                                                class="sp">*</span></label>
                                        <div class="prevPhoto">
                                ...
                                <input type="button" class="input" id="registroBicicletas" value="Registrar Bicicleta">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" aria-label="Close">
                                <a href="bicicletas" style="text-decoration:none; color:red;"><span
                        ...
                        <div style="text-align:center;">
                            <hr>
                            <a href="bicicletas"><button type="button" class="btn btn-danger"
    ...
    <script src="../js/registroBicicletas.js"></script>
